# Development and Testing Guide <br/> Pip.Services Prometheus for Golang
...
If you are planning to develop and test you may need to install Prometheus servers:
- Download and install Prometheus and Pushgateway from https://prometheus.io/download/

## <a name="install"></a> Installing

After your environment is ready you can check out source code from the Github repository:
```bash
git clone git@github.com:pip-services/pip-services-prometheus-go.git
```
